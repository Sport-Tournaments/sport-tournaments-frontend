                    ...
                    {registrations.map((registration) => (
                      <tr key={registration.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                          ...
                          <Link href={`/dashboard/dashboard/registrations/${registration.id}`}>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <Link href={`/dashboard/dashboard/tournaments/${tournament.id}/edit`}>
        ...
        {tournament.status === ('PUBLISHED' as TournamentStatus) && (
          <Alert variant="info" className="flex items-center justify-between">
            <span>Tournament is published. Open registration to accept teams.</span>
            <Button
              variant="primary"
              size="sm"
              onClick={() => handleStatusChange('REGISTRATION_OPEN' as TournamentStatus)}
            >
              Open Registration
            </Button>
          </Alert>
