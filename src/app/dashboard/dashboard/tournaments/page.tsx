  ...
  const columns = [
    {
      ...
      render: (tournament: Tournament) => (
        <Link href={`/dashboard/dashboard/tournaments/${tournament.id}`} className="font-medium text-primary hover:underline">
          {tournament.name}
        </Link>
      ),
    },
    ...
    },
    {
      ...
      render: (tournament: Tournament) => (
        <div className="flex gap-2">
          <Link href={`/dashboard/dashboard/tournaments/${tournament.id}`}>
