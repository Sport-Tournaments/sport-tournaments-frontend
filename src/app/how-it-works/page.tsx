  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* CTA Section */}
        <section className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="px-8 py-3 border border-indigo-600 text-indigo-600 dark:text-indigo-400 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors font-semibold"
            >
              Browse Tournaments
            </Link>
          </div>
