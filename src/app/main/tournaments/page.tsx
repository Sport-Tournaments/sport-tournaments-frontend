      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 mb-6">
          <div className="flex items-center gap-2">
            ...
            <div className="flex rounded-lg p-1 bg-white border border-[var(--uefa-blue)]">
              <button
                onClick={() => setViewMode("list")}
                className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-md transition-colors border border-transparent ${
                  viewMode === "list"
                    ? "bg-[var(--uefa-blue)] text-white"
                    : "text-[var(--uefa-blue)] hover:bg-[var(--uefa-blue)]/10"
                }`}
