...
export default function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[var(--uefa-blue)] text-white">
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="lg:hidden -m-2.5 inline-flex items-center justify-center rounded-lg p-2.5 text-white/80 hover:bg-white/10"
          ...
          <div className="flex items-center gap-x-2 sm:gap-x-4">
            ...
            <Dropdown
              trigger={
                <button className="flex items-center gap-1 rounded-lg px-2 py-1.5 text-sm font-medium text-white/85 hover:bg-white/10 transition-colors">
