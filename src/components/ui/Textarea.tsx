...
const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    ...
    const baseStyles = 'block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[#1e3a5f] sm:text-sm/6 min-h-[100px] resize-y';
